	...
	<div class="loading style-2 error">
		...
		<header>			
			<div class="blue darken-2 report-info right">
				<div class='report-name left'>JSON Validator</div>
				<!-- nav -->
				<nav>			
					<ul id='slide-out' class='right'>
						...
						<li class='analysis waves-effect'><a href='#!' class='urls-view' onclick="_updateCurrentStage(2)"><i class='mdi-action-language'></i> URLs</a></li>
						<li class='analysis waves-effect'><a href='#!' class='categories-view' onclick="_updateCurrentStage(1)"><i class='mdi-maps-local-offer'></i> Content Types</a></li>
						<li class='analysis waves-effect'><a href='#!' class='test-view' onclick="_updateCurrentStage(0)"><i class='mdi-action-dashboard'></i> Components</a></li>				
					</ul>			
				</nav>
		<!-- /nav -->		
			</div>						
				...
				<div class='charts'>
					<div class='col s12 m6 l4 fh'> 
						<div class='card-panel'> 
							<div>
								<span class='panel-name'><b>Unique Component View</b></span>
							</div> 							
							<div class='chart-box'>
								<canvas class='text-centered' id='test-analysis'></canvas>
							</div> 
							<div>
								<span class='weight-light'>Passed: <span class='t-pass-count weight-normal'>${dashboard.passedTests}</span> component(s)</span>
							</div> 
							<div>
								<span class='weight-light'>Failed: <span class='t-fail-count weight-normal'>${dashboard.failedTests+dashboard.fatalTests+dashboard.errorTests}</span> component(s)</span>
							</div> 
							<div>
								<span class='weight-light'>Others: <span class='t-others-count weight-normal'>${dashboard.otherTests}</span> component(s)</span>
							</div> 
						</div> 
					</div> 
					<div class='col s12 m6 l4 fh'> 
						<div class='card-panel'> 
							<div>
								<span class='panel-name'><b>Component Execution View</b></span>
							</div> 							 
							<div class='chart-box'>
								<canvas class='text-centered' id='step-analysis'></canvas>
							</div> 
							<div>
								<span class='weight-light'>Passed: <span class='s-pass-count weight-normal'></span>${dashboard.passedSteps} component(s)</span>
							</div> 
							<div>							
								<span class='weight-light'>Failed: <span class='s-fail-count weight-normal'></span>${dashboard.failedSteps+dashboard.fatalSteps+dashboard.errorSteps} component(s)</span>
							</div> 
							<div>
								<span class='weight-light'>Others: <span class='s-others-count weight-normal'></span>${dashboard.otherSteps} component(s)</span>
							</div> 
						</div> 
					</div>
		...
		<div id='testDataCount' class='hide'>
			...
			<input type='hidden' id='host' name='host' value='${dashboard.ip}'>			
		</div>
