...
/**
 * Will scroll viewport and shoot to get an image of full page. Useful for
 * browsers on portable devices.
 * 
...
public class ViewportPastingDecorator extends ShootingDecorator {
	...
	return ((Number) js.executeScript("var scrY = window.scrollY;" + "if(scrY){return scrY;} else {return 0;}"))
		.intValue();
    }
