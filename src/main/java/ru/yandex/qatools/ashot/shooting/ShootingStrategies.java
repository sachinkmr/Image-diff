...
public final class ShootingStrategies {
     ...
     *            Shooting strategy used to take screenshots before scaling
     * @param dpr
     *            device pixel ratio
     * @return {@code ShootingStrategy} that will scale image according to
     *         {@code dpr}
     */
     ...
     *
     * @param shootingStrategy
     *            Shooting strategy used to take screenshots before cutting
     * @param cutStrategy
     *            {@link CutStrategy} to use. See {@link FixedCutStrategy} or
     *            {@link VariableCutStrategy}
     ...
     *
     * @param headerToCut
     *            header to cut in pixels
     * @param footerToCut
     *            footer to cut in pixels
     * @return {@code ShootingStrategy} with {@link FixedCutStrategy} cutting
     *         strategy
     */
     ...
     *
     * @param shootingStrategy
     *            Shooting strategy used to take screenshots between scrolls
     * @param scrollTimeout
     *            time between viewportPasting scrolls in milliseconds
    ...
    /**
     * Will scroll viewport while shooting and cut off browser's header and
     * footer
     *
     * @param shootingStrategy
     *            Underneath shooting strategy
     * @param scrollTimeout
     *            time between scrolls in milliseconds
     * @param cutStrategy
     *            strategy to cut header and footer from image
     *
     * @return {@code ShootingStrategy} with custom scroll timeout and cutting
     *         strategy
     */
    ...
    /**
     * Will scroll viewportPasting while shooting and cut off browser's header
     * and footer
     *
     * @param scrollTimeout
     *            time between scrolls in milliseconds
     * @param headerToCut
     *            height of header to cut from image
     * @param footerToCut
     *            height of footer to cut from image
     *
     * @return {@code ShootingStrategy} with custom scroll timeout and
     *         header/footer to cut
     */
    ...
    /**
     * Will scale screenshots and scroll viewportPasting while shooting and cut
     * off browser's header/footer
     *
     * @param shootingStrategy
     *            Underneath shooting strategy
     * @param scrollTimeout
     ...
     *            device pixel ratio
     *
     * @return {@code ShootingStrategy} with custom DPR scaling and scroll
     *         timeout and cutting strategy
     */
     ...
     * @param cutStrategy
     *            strategy to cut header and footer from image
     * @return {@code ShootingStrategy} which will shoot whole page and rotate
     *         landscape images
     */
