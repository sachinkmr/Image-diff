 ...
 * For example, Safari browser in iOS 8 introduced a feature (so called
 * 'minimal-ui')<br>
...
public class VariableCutStrategy implements CutStrategy {
    ...
    /**
     * @param headerMin
     *            - minimal header height (for Safari iOS 8 it is 41px)
     * @param headerMax
     *            - maximum header height (for Safari iOS 8 it is 65px)
     * @param footerMin
     *            - minimal footer height (for Safari iOS 8 it is 0px)
     * @param footerMax
     *            - maximum footer height (for Safari iOS 8 it is 89px)
     * @param windowInnerHeightMin
     *            - minimal height of viewportPasting (when header with address
     *            bar shown).<br />
     *            For real device iPad 2 it is 960px (portrait) and 674px
     *            (landscape).<br />
     *            For simulated iPad 2 it is 1225px (portrait) and 687px
     *            (landscape).
     */
