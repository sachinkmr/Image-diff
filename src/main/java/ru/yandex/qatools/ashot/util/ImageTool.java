...
public final class ImageTool {
	...
	return new Coords(Math.max(0, coordinates.x - indent), Math.max(0, coordinates.y - indent),
	...
	return Math.abs(red1 - red2) <= inaccuracy && Math.abs(green1 - green2) <= inaccuracy
