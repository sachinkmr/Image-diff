...
public final class ImageBytesDiffer {
	...
	return actual.getDataType() == expected.getDataType() && actual.getNumBanks() == expected.getNumBanks()
		&& actual.getSize() == expected.getSize() && areImagesBytesEqual(actual, expected);
    }
