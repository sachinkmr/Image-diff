...
public abstract class DiffMarkupPolicy {
	...
	Color negativeColor = new Color(0xFFFFFF - diffColor.getRGB()); // negate
									// diff
									// color
	return new byte[] { (byte) negativeColor.getRed(), (byte) negativeColor.getGreen(),
		(byte) negativeColor.getBlue(), (byte) diffColor.getRed(), (byte) diffColor.getGreen(),
