...
public class ImageDiff {
	...
	/**
	 * Sets the maximum number of distinguished pixels when images are still
	 * considered the same.
	 *
	 * @param diffSizeTrigger
	...
	/**
	 * Marks diff on inner image and returns it. Idempotent.
	 *
	...
	/**
	 * Marks diff points on transparent canvas and returns it. Idempotent.
	 *
	 * @return marked diff image
	 */
