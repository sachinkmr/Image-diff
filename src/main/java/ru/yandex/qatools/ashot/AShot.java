...
public class AShot implements Serializable {
     ...
     * 
     * @param area
     *            coords of wittingly ignored coords
     * @return aShot;
     */
    @SuppressWarnings("UnusedDeclaration")
    ...
    /**
     * Takes the screenshot of given elements If elements were not found
     * screenshot of whole page will be returned
     *
     * @param driver
     *            WebDriver instance
     * @param elements
     *            Web elements to screenshot
     * @return Screenshot with cropped image and list of ignored areas on
     *         screenshot
     ...
     * @param driver
     *            WebDriver instance
     * @return Screenshot with whole page image and list of ignored areas on
     *         screenshot
     * @see Screenshot
     */
