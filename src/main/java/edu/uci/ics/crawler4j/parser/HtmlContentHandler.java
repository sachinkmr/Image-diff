...
public class HtmlContentHandler extends DefaultHandler {
	...
	private enum Element {
		A, AREA, LINK, IFRAME, FRAME, EMBED, IMG, BASE, META, BODY, SCRIPT, STYLE
	}
	...
	public void startElement(String uri, String localName, String qName, Attributes attributes) throws SAXException {
		...
		if ((element == Element.A) || (element == Element.AREA) || (element == Element.LINK)) {
			...
			if (imgSrc != null) {
				...
				|| (element == Element.SCRIPT) || (element == Element.STYLE)) {
			...
			if (equiv == null) { // This condition covers several cases of XHTML
				// meta
