...
public class WebCrawler implements Runnable {
    ...
    /**
     * This function is called if the content of a url is bigger than allowed
     * size.
     *
     * @param urlStr
     ...
     *
     * @param urlStr
     *            URL in which an unexpected error was encountered while
     *            crawling
     * @param statusCode
     *            Html StatusCode
     * @param contentType
    ...
    /**
     * This function is called when a unhandled exception was encountered during
     * fetching
     *
     * @param webUrl
    ...
    /**
     * Classes that extends WebCrawler should overwrite this function to tell
     * the crawler whether the given url should be crawled or not. The following
	...
	try {
		...
		if (statusCode == HttpStatus.SC_MOVED_PERMANENTLY || statusCode == HttpStatus.SC_MOVED_TEMPORARILY
			...
			webURL.setInternalLink(Net.getWebUrlType(webURL, myController.getConfig().getSiteHost()));
