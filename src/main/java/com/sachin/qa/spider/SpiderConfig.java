...
public class SpiderConfig extends CrawlConfig {
	...
	if (null != AppConstants.USERNAME && !AppConstants.USERNAME.isEmpty()) {
	    try {
		this.addAuthInfo(
			new BasicAuthInfo(AppConstants.USERNAME, AppConstants.PASSWORD, AppConstants.SITE));
	...
	this.setMaxDownloadSize(Integer.parseInt(AppConstants.PROPERTIES.getProperty("crawler.maxDownloadSize",
