...
public class NetUtils {
	...
	public static CloseableHttpResponse getUrlResponse(String... data) throws ClientProtocolException, IOException {
		...
		clientBuilder.setUserAgent(SpiderConstants.PROPERTIES.getProperty("crawler.userAgentString",
	...
	public static Response getFluentResponse(String... data) throws ClientProtocolException, IOException {
		...
		Request request = Request.Get(add)
				.addHeader("user-agent",
						SpiderConstants.PROPERTIES.getProperty("crawler.userAgentString",
								"Mozilla/5.0 (Windows NT 10.0; WOW64; rv:48.0) Gecko/20100101 Firefox/48.0"))
				.connectTimeout(
						Integer.parseInt(SpiderConstants.PROPERTIES.getProperty("crawler.connectionTimeout", "120000")))
				.socketTimeout(Integer
						.parseInt(SpiderConstants.PROPERTIES.getProperty("crawler.connectionTimeout", "120000")));
