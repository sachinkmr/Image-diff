...
import com.sachin.qa.dgt.page.D2Page;
import com.sachin.qa.dgt.selenium.Browser;
import com.sachin.qa.dgt.utils.HelperUtils;
import com.sachin.qa.dgt.utils.NetUtils;
...
public class AppConstants {
	...
	WEB = System.getProperty("web") != null && !System.getProperty("web").isEmpty()
		&& System.getProperty("web").equalsIgnoreCase("Yes");
	if (WEB) {
	...
	if (flag) {
		...
		storage = new File(System.getProperty("app.dir") + File.separator + "data" + File.separator + host
			+ File.separator + BUILD_VERSION);
	    } else {
		storage = new File(System.getProperty("app.dir") + File.separator + "data" + File.separator + BRAND_NAME
			+ File.separator + BUILD_VERSION);
	    }
