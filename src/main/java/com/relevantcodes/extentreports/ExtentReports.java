...
public class ExtentReports extends Report implements Serializable {
	 ...
	 *            Setting to overwrite (TRUE) the existing file or append
	 *            (FALSE) to it
	 *            <ul>
	 *            <li>true - the file will be replaced with brand new markup,
	 *            and all existing data will be lost. Use this option to create
	 *            a brand new report</li>
	 *            <li>false - existing data will remain, new tests will be
	 *            appended to the existing report. If the the supplied path does
	 *            not exist, a new file will be created.</li>
	 *            </ul>
	 * 
	 * @param displayOrder
	 *            Determines the order in which your tests will be displayed
	 *            <ul>
	 *            <li>OLDEST_FIRST (default) - oldest test at the top, newest at
	 *            the end</li>
	 *            <li>NEWEST_FIRST - newest test at the top, oldest at the
	 *            end</li>
	 *            </ul>
	 * 
	 * @param networkMode
	 *            <ul>
	 *            <li>ONLINE - creates a single report file with all
	 *            artifacts</li>
	 *            <li>OFFLINE - all report artifacts will be stored locally in
	 *            <code>%reportFolder%/extentreports</code> with the following
	 *            structure: <br>
	 ...
	 * 
	 * @param locale
	 *            Locale to adapt for the report. All standard text for the
	 *            report will be displayed in the selected locale.
	 */
	...
	/**
	 * <p>
	 * Initializes a localized version of Extent HTML report. To see a list of
	 * supported locales, visit: http://extentreports.relevantcodes.com
	 * 
	 * <ul>
	 * <li>Default setting <code>NetworkMode.ONLINE</code> for
	 * {@link NetworkMode} is used</li>
	 * </ul>
	 * 
	 * @param filePath
	 *            Path of the file, in .htm or .html format
	 ...
	 * 
	 * <ul>
	 * <li>Default setting <code>DisplayOrder.OLDEST_FIRST</code> is used for
	 * {@link DisplayOrder}</li>
	 * </ul>
	 * 
	 * @param filePath
	 *            Path of the file, in .htm or .html format
	 ...
	 * 
	 * <p>
	 * Note: a new report will be created by default since
	 * <code>replaceExisting</code> is <code>true</code> by default
	 * 
	 * <p>
	 * Examples:
	 * 
	 * <ul>
	 * <li>English (default):
	 * <code>new ExtentReports("filePath", Locale.ENGLISH);</code></li>
	 * <li>Spanish locale:
	 * <code>new ExtentReports("filePath", new Locale("es"));</code></li>
	 * </ul>
	 * 
	 * @param filePath
	 *            Path of the file, in .htm or .html format
	 ...
	 * 
	 * <p>
	 * Note: Each time an instance of <code>ExtentReports</code> is created, a
	 * unique UUID is created for that instance automatically. This unique UUID
	 * is also stored in the database (if the database reporter is started).
	 * 
	 * @return Report's unique {@link UUID}
	 */
	 ...
	 * /**
	 * <p>
	 * Initializes ExtentX and connects to MongoDB using default host
	...
	/**
	 * <p>
	 * Initializes ExtentX and connects to MongoDB using host and default port
	 * (27017)
	 * 
	 * @param host
	 ...
	 * 
	 * <p>
	 * Creates a Mongo described by a URI. If only one address is used
	 * MongoClient will only connect to that node, otherwise it will discover
	 * all nodes
	 * 
	 * @param uri
	 *            The URI
	...
	/**
	 * <p>
	 * Initializes ExtentX and connects to MongoDB. Creates a Mongo based on a
	 * list of replica set members or a list of mongos.
	 * 
	 * @param seeds
	 *            List of mongod servers in the same replica set or a list of
	...
	/**
	 * <p>
	 * Initializes ExtentX and connects to MongoDB based on a list of replica
	 * set members or a list of mongos
	 * 
	 * @param seeds
	 *            List of mongod servers in the same replica set or a list of
	 *            mongos servers in the same sharded cluster
	...
	/**
	 * <p>
	 * Starts a custom reporter based upon {@link ReporterType}. The file
	 * extension determines if the reporter-type will be started.
	 * 
	 * <p>
	 * For <code>ReporterType</code> the extension must be <code>.db</code>
	 * 
	 * @param reporterType
	 *            {@link ReporterType} Type of the reporter to be initialized
	 * 
	 * @param filePath
	 *            Path of the report source, with the correct extension for the
	 *            reporter
	 * 
	 * @return An {@link ExtentReports} object
	 */
	...
	/**
	 * <p>
	 * Calling startTest() generates a toggle for the test in the HTML file and
	 * adds all log events under this level. This is a required step and without
	 * calling this method the toggle will not be created for the test and log
	 * will not be added.
	 * 
	 * @param testName
	 *            Name of the test
	 ...
	 * 
	 * <p>
	 * If <code>ReporterType.DB</code> is used, a row in the TEST table is
	 * created
	 * 
	 * @param extentTest
	 ...
	 * 
	 * <p>
	 * Note: If <code>flush()</code> is called before any of the ended tests, no
	 * information will be appended.
	 * 
	 * <p>
	 * Note: If <code>flush()</code> is called while the test is running (not
	 * yet ended), it will not be appended to the report.
	 */
	@Override
	 ...
	 * 
	 * <p>
	 * Once close is called, additional information will not be sent to the
	 * report. Any attempt to <code>flush()</code> will result in a
	 * <code>IOException</code>.
	 * 
	 * <p>
	 * If any of your test ended abruptly causing any side-affects (not all logs
	 * sent to ExtentReports, information missing), this method will ensure that
	 * the test is still appended to the report with a warning message.
	 */
